...
const FName ACommanderAI::AIHaviorSequenceIndexKey(TEXT("AIHaviorSequenceIndexKey"));
...
void ACommanderAI::StartAITurn()
{
	...
	if (!bBehaviorTreeStarted)
	{
		...
		FHaviorStateSequence TurnEndHavior;
		TurnEndHavior.HaviorCode = EAIBehaviorCode::Havior_TurnEnd;
		TurnEndHavior.AIHaviorState = EAIBehaviorState::TurnEnd;
		TurnEndHavior.SpawnObjectType = ESpawnObject::None;
